...
func _create_zone() -> void:
	...
	shop1.color = Color(0.6, 0.4, 0.2)
	shop1.position = Vector2(80, 100)
	add_child(shop1)
	var shop1_label = Label.new()
	shop1_label.text = "Tüccar"
	shop1_label.position = Vector2(80, 90)
	shop1_label.add_theme_font_size_override("font_size", 6)
	add_child(shop1_label)

	var shop2 = ColorRect.new()
	shop2.size = Vector2(50, 40)
	shop2.color = Color(0.4, 0.3, 0.5)
	shop2.position = Vector2(80, 180)
	add_child(shop2)
	var shop2_label = Label.new()
	shop2_label.text = "Demirci"
	shop2_label.position = Vector2(80, 170)
